...
export const CATEGORIES: Category[] =[
  { id: 'urgente', title: 'Urgente', icon: 'AlertTriangle', color: 'bg-red-50 text-red-600 border-red-200' },
  { id: 'respiracion', title: 'Respiración', icon: 'Wind', color: 'bg-blue-50 text-blue-600 border-blue-200' },
  { id: 'secreciones', title: 'Aspiración', icon: 'Droplets', color: 'bg-cyan-50 text-cyan-600 border-cyan-200' },
  { id: 'dolor', title: 'Dolor', icon: 'Activity', color: 'bg-orange-50 text-orange-600 border-orange-200' },
  { id: 'posicion', title: 'Posición', icon: 'Move', color: 'bg-indigo-50 text-indigo-600 border-indigo-200' },
  { id: 'familia', title: 'Familia', icon: 'Users', color: 'bg-purple-50 text-purple-600 border-purple-200' },
  { id: 'necesidades', title: 'Necesidades', icon: 'Coffee', color: 'bg-emerald-50 text-emerald-600 border-emerald-200' },
  { id: 'emociones', title: 'Emociones', icon: 'Heart', color: 'bg-pink-50 text-pink-600 border-pink-200' }
];
...
export const MOCK_PHRASES: Phrase[] =[
  ...
  { id: 'p12', text: 'Necesito ayuda para ir al baño', categoryId: 'necesidades' },
