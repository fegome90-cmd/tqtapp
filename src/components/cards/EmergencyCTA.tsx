...
export default function EmergencyCTA({ onClick, isPlaying }: EmergencyCTAProps) {
  return (
    <button
      ...
      onClick={onClick}
      className={[
        'w-full bg-primary-container hover:brightness-110 rounded-3xl shadow-[0_8px_24px_-8px_rgba(1,67,137,0.25)] p-6 flex items-center gap-5 text-left active:scale-[0.98] transition-transform',
